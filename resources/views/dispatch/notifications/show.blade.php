            ...
            <div class="flex items-start justify-between">
                ...
                <div class="flex-shrink-0">
                    ...
                    <span class="inline-flex items-center px-4 py-2 rounded-full text-sm font-bold bg-orange-200 text-orange-800">
                        <i class="fas fa-circle mr-2 text-xs "></i>Pending
                    </span>
                    @else
                        ...
                        <div class="p-4">
                            ...
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold
                                {{ $notification->trip->status === 'completed' ? 'bg-green-100 text-green-800' : 
                                   ($notification->trip->status === 'in-transit' ? 'bg-gradient-to-r from-blue-500 to-indigo-600 text-white shadow-md font-bold' : 
