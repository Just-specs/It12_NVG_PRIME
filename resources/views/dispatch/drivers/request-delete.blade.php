...
@section('title', 'Request Driver Deletion')
...
<div class="container mx-auto px-4 max-w-2xl">
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="bg-blue-50 border-l-4 border-blue-500 p-4 mb-6 rounded">
            <h3 class="font-semibold text-blue-900 mb-2">Driver to be Deleted:</h3>
        ...
        <!-- Request Form -->
        <form method="POST" action="{{ route('drivers.submitDeleteRequest', $driver) }}">
            @csrf
            ...
            <div class="mb-6">
                ...
                <textarea 
                    ...
                    placeholder="Explain why this driver needs to be deleted (minimum 10 characters)...">{{ old('reason') }}</textarea>
