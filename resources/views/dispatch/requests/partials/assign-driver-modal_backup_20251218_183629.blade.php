...
<script>
    ...
    function initAssignDriverModal() {
        ...
        form?.addEventListener('submit', function(e) {
            ...
            const deliveryRequestIdField = document.querySelector('input[name="delivery_request_id"]');
            
            // Log all form data before submission
            console.log('=== Show Page Modal Form Submission ===');
            ...
            console.log('scheduled_time:', document.querySelector('input[name="scheduled_time"]')?.value);
            console.log('======================================');
            ...
            if (!deliveryRequestIdField || !deliveryRequestIdField.value || deliveryRequestIdField.value === '') {
                ...
                alert('Error: Delivery request information is missing. Please refresh the page and try again.');
                return false;
            }
