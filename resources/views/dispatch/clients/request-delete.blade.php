...
@section('title', 'Request Client Deletion')
...
<div class="container mx-auto px-4 max-w-2xl">
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="bg-green-50 border-l-4 border-green-500 p-4 mb-6 rounded">
            <h3 class="font-semibold text-green-900 mb-2">Client to be Deleted:</h3>
        ...
        <!-- Request Form -->
        <form method="POST" action="{{ route('clients.submitDeleteRequest', $client) }}">
            @csrf
            ...
            <div class="mb-6">
                ...
                <textarea 
                    ...
                    placeholder="Explain why this client needs to be deleted (minimum 10 characters)...">{{ old('reason') }}</textarea>
