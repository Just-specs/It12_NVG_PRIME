...
@section('content')
<div class="relative min-h-screen flex items-center justify-center px-1 py-1">
        ...
        <div class="overflow-hidden rounded-3xl border border-blue-500/20 bg-white/70 text-blue-900 shadow-xl shadow-blue-900/10">
            <div class="px-5 pt-2 text-center">
                ...
                <p class="mt-2 text-sm text-blue-600">
                    RVG Prime Movers - Dispatch Management
                </p>
            </div>

            <div class="space-y-1 px-8 pb-10 pt-6">
                @if ($errors->any())
                <div class="flex items-start gap-3 rounded-2xl border border-rose-500/30 bg-rose-500/15 p-4 text-left">
                    <div class="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-xl bg-rose-500/20 text-rose-300">
                ...
                <form class="space-y-5" action="{{ route('register.post') }}" method="POST">
                    ...
                    <div class="space-y-4">
                        <div>
                            <label for="name" class="mb-2 block text-sm font-semibold text-blue-900">
                                Full Name:
                            </label>
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    autocomplete="name"
                                    required
                                    class="w-full rounded-2xl border-2 border-blue-300 bg-blue-200 py-3 pl-11 pr-4 text-sm text-blue-950 caret-blue-700 placeholder-blue-500 shadow-lg shadow-blue-900/15 transition focus:border-blue-400 focus:bg-white focus:text-blue-950 focus:outline-none focus:ring-4 focus:ring-blue-200/70 @error('name') border-rose-400/60 focus:ring-rose-500/30 @enderror"
                                    placeholder="Enter your full name"
                                    value="{{ old('name') }}">
                            </div>
                            @error('name')
                            <p class="mt-1.5 text-xs text-rose-200">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    autocomplete="new-password"
                                    required
                                    class="w-full rounded-2xl border-2 border-blue-300 bg-blue-200 py-3 pl-11 pr-4 text-sm text-blue-950 caret-blue-700 placeholder-blue-500 shadow-lg shadow-blue-900/15 transition focus:border-blue-400 focus:bg-white focus:text-blue-950 focus:outline-none focus:ring-4 focus:ring-blue-200/70"
                    ...
                    <p class="text-center text-sm text-blue-800">
                        ...
                        <a href="{{ route('login') }}" class="font-medium text-blue-600 transition hover:text-blue-800">
                            Sign in here
                        </a>
                    </p>
                </form>
